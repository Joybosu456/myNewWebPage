        ...
        <>
            <div className="aboutme">
                ...
                <div className="aboutdetials">
                    <p className="aboutinfo">Hello, Joy Basu, a passionate software developer
                        with expertise in ReactJs,JavaScript, Git, HTML, and CSS.
                        Currently, I'm expanding my skills to include Dot Net and MySql,
                        ...
                        scalable Frontend systems, I've collaborated with cross-functional teams
                        to deliver successful projects. Outside of work, I enjoy reading suspense
                        thriller Movies and playing Badminton and cricket.</p>d
                ...
                <div className="techskills">
                    <div className="skillsection">
                        <div>
                            ...
                            <div className="skilltiptext">REACTJS</div>
                        </div>
                        <div>
